      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="card-professional p-4 bg-green-50 border border-green-200">
          ...
          <div className="space-y-2">
            <div className="bg-green-50 rounded-lg max-h-48 overflow-y-auto p-1 space-y-2">
              {metrics
                ? metrics.split(/\r?\n/).filter(Boolean).map((line, idx) => {
                    ...
                    return (
                      <div key={idx} className="flex items-start bg-blue-50 rounded-lg p-1">
        ...
        <div className="card-professional p-4 bg-gray-50 border border-gray-200">
          <div className="flex items-center space-x-2 mb-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-blue-50 border border-blue-200">
              ...
              <span className="text-blue-600 font-semibold">1 files</span>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-green-50 border border-green-200">
              ...
              <span className="text-green-600 font-semibold">1 files</span>
            </div>
            ...
            {/* <div className="flex items-center justify-between p-3 bg-red-50 border border-red-200 ">
              ...
              <span className="text-red-600 font-semibold">0 file</span>
            </div> */}
          </div>
        </div>

        {/* Download Card */}
        <div className="card-professional p-4 w-full md:col-span-2 bg-blue-50 border border-blue-200">
          <div className="flex items-center space-x-2 mb-4">
